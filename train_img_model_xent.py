...
# Datasets
parser.add_argument('--root', type=str, default='F:\chrome downloads\dataset\Market-1501-v15.09.15', help="root path to data directory")
...
# Architecture
parser.add_argument('-a', '--arch', type=str, default='osnet_x1_0', choices=models.get_names())
# Miscs
